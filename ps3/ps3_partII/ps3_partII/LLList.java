...
public class LLList implements List {
    ...
    /*
    * takes a refrence to an ArrayList as its only parameter and constructs an LLList object that represents the 
    * same list as ArrayList with items in the same positons in the list
    */ 
    ...
    public static void main(String[] args){
        ...
        System.out.println("arraylist:"+al1.toString());
        LLList l1 = new LLList(al1);
        System.out.println("LLList:"+l1.toString());

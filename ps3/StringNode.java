...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        if (str == null) {
            ...
            StringNode copyStart = new StringNode(str.ch,null);
            StringNode prevN = copyStart;
            str = str.next;
            do{
    ...
    /**
     * isPrefix - determines if the linked-list string specified by
     * prefix is a prefix of the linked-list string specified by str
     * -- i.e., if str starts with the characters in prefix. It
    ...
    public static boolean isPrefix(StringNode prefix, StringNode str) {
        // Three base cases.
        if (prefix == null) {
            return true;          // successfully processed all of prefix
        } else if (str == null) {
    ...
    public static StringNode read(InputStream in) throws IOException { 
        ...
        if (ch == '\n') {    // the string ends when we hit a newline char
            return null;         
        } else {
    ...
    /*
     * replace replaces evry intance of oldchar with new char in a string node list and returns a copy 
     * of the initial list with the oldChars replaced
     */
    public static StringNode replace(StringNode str, char oldChar , char newChar){
        if (str == null) {
            ...
            do{
                if(str.ch == oldChar){
                    StringNode copy = new StringNode(newChar,null);
                    prevN.next = copy;
                    prevN = copy;
                    str = str.next; 
                }
